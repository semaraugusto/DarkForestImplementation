...
snarkjs groth16 prove final.zkey witness_move.wtns proof_move.json public_move.json
snarkjs groth16 verify verification_key.json public_move.json proof_move.json
snarkjs zkey export solidityverifier final.zkey moveverifier.sol
